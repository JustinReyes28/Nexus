...
export const renderVerificationEmail = (code: string) => {
  ...
  return emailLayout(`
    ...
    <div style="text-align: center; margin: 40px 0;">
      <span style="font-size: 32px; font-weight: bold; letter-spacing: 5px; color: #06d6a0; background: #f3f4f6; padding: 10px 20px; border-radius: 8px; border: 1px solid #e5e7eb;">${escapedCode}</span>
    </div>
